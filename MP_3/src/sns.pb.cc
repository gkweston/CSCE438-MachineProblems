...
constexpr Registration::Registration(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
...
struct RegistrationDefaultTypeInternal {
  constexpr RegistrationDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT RegistrationDefaultTypeInternal _Registration_default_instance_;
constexpr Assignment::Assignment(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : sid_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , hostname_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , port_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string){}
struct AssignmentDefaultTypeInternal {
  constexpr AssignmentDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT AssignmentDefaultTypeInternal _Assignment_default_instance_;
}  // namespace csce438
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_sns_2eproto[6];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_sns_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::csce438::Registration, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::csce438::Registration, sid_),
  PROTOBUF_FIELD_OFFSET(::csce438::Registration, hostname_),
  PROTOBUF_FIELD_OFFSET(::csce438::Registration, port_),
  PROTOBUF_FIELD_OFFSET(::csce438::Registration, type_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::csce438::Assignment, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::csce438::Assignment, sid_),
  PROTOBUF_FIELD_OFFSET(::csce438::Assignment, hostname_),
  PROTOBUF_FIELD_OFFSET(::csce438::Assignment, port_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 32, -1, -1, sizeof(::csce438::Registration)},
  { 42, -1, -1, sizeof(::csce438::Assignment)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::csce438::_Registration_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::csce438::_Assignment_default_instance_),
};
...
const char descriptor_table_protodef_sns_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \001(\t\022\014\n\004type\030\004 \001(\t\"9\n\nAssignment\022\013\n\003sid\030"
  "\001 \001(\t\022\020\n\010hostname\030\002 \001(\t\022\014\n\004port\030\003 \001(\t2\375\001"
  "\n\nSNSService\022+\n\005Login\022\020.csce438.Request\032"
  "\016.csce438.Reply\"\000\022.\n\004List\022\020.csce438.Requ"
  "est\032\022.csce438.ListReply\"\000\022,\n\006Follow\022\020.cs"
  ...
  "Message\"\000(\0010\0012\216\001\n\025SNSCoordinatorService\022"
  "9\n\016RegisterServer\022\025.csce438.Registration"
  "\032\016.csce438.Reply\"\000\022:\n\017FetchAssignment\022\020."
  "csce438.Request\032\023.csce438.Assignment\"\000b\006"
  "proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sns_2eproto = {
  false, false, 806, descriptor_table_protodef_sns_2eproto, "sns.proto", 
  &descriptor_table_sns_2eproto_once, descriptor_table_sns_2eproto_deps, 1, 6,
...
Registration::Registration(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:csce438.Registration)
}
Registration::Registration(const Registration& from)
  ...
  // @@protoc_insertion_point(copy_constructor:csce438.Registration)
}
...
Registration::~Registration() {
  // @@protoc_insertion_point(destructor:csce438.Registration)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:csce438.Registration)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "csce438.Registration.sid"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "csce438.Registration.hostname"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "csce438.Registration.port"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "csce438.Registration.type"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Registration::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:csce438.Registration)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:csce438.Registration)
  return target;
}

size_t Registration::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:csce438.Registration)
  size_t total_size = 0;
...
void Registration::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<Registration *>(to)->MergeFrom(
      static_cast<const Registration &>(from));
}


void Registration::MergeFrom(const Registration& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:csce438.Registration)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:csce438.Registration)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
Assignment::Assignment(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:csce438.Assignment)
}
Assignment::Assignment(const Assignment& from)
  ...
  // @@protoc_insertion_point(copy_constructor:csce438.Assignment)
}
...
Assignment::~Assignment() {
  // @@protoc_insertion_point(destructor:csce438.Assignment)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:csce438.Assignment)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          auto str = _internal_mutable_sid();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "csce438.Assignment.sid"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          auto str = _internal_mutable_hostname();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "csce438.Assignment.hostname"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          auto str = _internal_mutable_port();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "csce438.Assignment.port"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Assignment::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:csce438.Assignment)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:csce438.Assignment)
  return target;
}

size_t Assignment::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:csce438.Assignment)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:csce438.Assignment)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:csce438.Assignment)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::csce438::Registration* Arena::CreateMaybeMessage< ::csce438::Registration >(Arena* arena) {
  return Arena::CreateMessageInternal< ::csce438::Registration >(arena);
}
template<> PROTOBUF_NOINLINE ::csce438::Assignment* Arena::CreateMaybeMessage< ::csce438::Assignment >(Arena* arena) {
  return Arena::CreateMessageInternal< ::csce438::Assignment >(arena);
}
