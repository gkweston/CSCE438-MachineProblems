...
static const char* SNSCoordinatorService_method_names[] = {
  "/csce438.SNSCoordinatorService/RegisterServer",
  "/csce438.SNSCoordinatorService/FetchAssignment",
};

std::unique_ptr< SNSCoordinatorService::Stub> SNSCoordinatorService::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< SNSCoordinatorService::Stub> stub(new SNSCoordinatorService::Stub(channel, options));
  return stub;
}

SNSCoordinatorService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_RegisterServer_(SNSCoordinatorService_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_FetchAssignment_(SNSCoordinatorService_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}

::grpc::Status SNSCoordinatorService::Stub::RegisterServer(::grpc::ClientContext* context, const ::csce438::Registration& request, ::csce438::Reply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::csce438::Registration, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_RegisterServer_, context, request, response);
}

void SNSCoordinatorService::Stub::async::RegisterServer(::grpc::ClientContext* context, const ::csce438::Registration* request, ::csce438::Reply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::csce438::Registration, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_RegisterServer_, context, request, response, std::move(f));
}

void SNSCoordinatorService::Stub::async::RegisterServer(::grpc::ClientContext* context, const ::csce438::Registration* request, ::csce438::Reply* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::csce438::Reply>* SNSCoordinatorService::Stub::PrepareAsyncRegisterServerRaw(::grpc::ClientContext* context, const ::csce438::Registration& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::csce438::Reply, ::csce438::Registration, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_RegisterServer_, context, request);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* SNSCoordinatorService::Stub::AsyncRegisterServerRaw(::grpc::ClientContext* context, const ::csce438::Registration& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status SNSCoordinatorService::Stub::FetchAssignment(::grpc::ClientContext* context, const ::csce438::Request& request, ::csce438::Assignment* response) {
  return ::grpc::internal::BlockingUnaryCall< ::csce438::Request, ::csce438::Assignment, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_FetchAssignment_, context, request, response);
}

void SNSCoordinatorService::Stub::async::FetchAssignment(::grpc::ClientContext* context, const ::csce438::Request* request, ::csce438::Assignment* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::csce438::Request, ::csce438::Assignment, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_FetchAssignment_, context, request, response, std::move(f));
}

void SNSCoordinatorService::Stub::async::FetchAssignment(::grpc::ClientContext* context, const ::csce438::Request* request, ::csce438::Assignment* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_FetchAssignment_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::csce438::Assignment>* SNSCoordinatorService::Stub::PrepareAsyncFetchAssignmentRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::csce438::Assignment, ::csce438::Request, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_FetchAssignment_, context, request);
}

::grpc::ClientAsyncResponseReader< ::csce438::Assignment>* SNSCoordinatorService::Stub::AsyncFetchAssignmentRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncFetchAssignmentRaw(context, request, cq);
  result->StartCall();
  return result;
}

SNSCoordinatorService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      SNSCoordinatorService_method_names[0],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SNSCoordinatorService::Service, ::csce438::Registration, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SNSCoordinatorService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::csce438::Registration* req,
             ::csce438::Reply* resp) {
               return service->RegisterServer(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      SNSCoordinatorService_method_names[1],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SNSCoordinatorService::Service, ::csce438::Request, ::csce438::Assignment, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SNSCoordinatorService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::csce438::Request* req,
             ::csce438::Assignment* resp) {
               return service->FetchAssignment(ctx, req, resp);
             }, this)));
}
...
::grpc::Status SNSCoordinatorService::Service::RegisterServer(::grpc::ServerContext* context, const ::csce438::Registration* request, ::csce438::Reply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status SNSCoordinatorService::Service::FetchAssignment(::grpc::ServerContext* context, const ::csce438::Request* request, ::csce438::Assignment* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
